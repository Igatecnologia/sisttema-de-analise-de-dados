...
export function PrivacyPolicyPage() {
  return (
    <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <Card>
        <Typography>
          <Typography.Title level={2}>1. Quais dados coletamos</Typography.Title>
          ...
          <Typography.Title level={2}>2. Bases legais</Typography.Title>
          <Typography.Paragraph>
          ...
          <Typography.Title level={2}>3. Compartilhamento (sub-processadores)</Typography.Title>
          <Typography.Paragraph>
          ...
          <Typography.Title level={2}>4. Seus direitos (LGPD Art. 18)</Typography.Title>
          <Typography.Paragraph>
            Acesso, correcao, anonimizacao, exclusao e portabilidade — todos disponiveis em /seguranca/lgpd. SLA de resposta: 15 dias uteis.
          </Typography.Paragraph>
          <Typography.Title level={2}>5. Retencao</Typography.Title>
          <Typography.Paragraph>
          ...
          <Typography.Title level={2}>6. DPO</Typography.Title>
          <Typography.Paragraph>
...
export function TermsOfServicePage() {
  return (
    <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <Card>
        <Typography>
          <Typography.Title level={2}>1. Objeto</Typography.Title>
          <Typography.Paragraph>
          ...
          <Typography.Title level={2}>2. SLA</Typography.Title>
          <Typography.Paragraph>
            Pro: 99% uptime mensal. Enterprise: 99.5% + suporte 4h. Free: best-effort. SLA NAO se aplica a indisponibilidade do ERP do cliente.
          </Typography.Paragraph>
          <Typography.Title level={2}>3. Limitacao de responsabilidade</Typography.Title>
          <Typography.Paragraph>
          ...
          <Typography.Title level={2}>4. Encerramento</Typography.Title>
          <Typography.Paragraph>
          ...
          <Typography.Title level={2}>5. Foro</Typography.Title>
          <Typography.Paragraph>
...
export function AccessibilityPage() {
  return (
    <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <Card>
        <Typography>
          <Typography.Title level={2}>Compromisso</Typography.Title>
          <Typography.Paragraph>
          ...
          <Typography.Title level={2}>O que ja esta implementado</Typography.Title>
          <ul>
          ...
          <Typography.Title level={2}>O que ainda esta em evolucao</Typography.Title>
          <ul>
          ...
          <Typography.Title level={2}>Reportar barreira de acessibilidade</Typography.Title>
          <Typography.Paragraph>
          ...
          <Typography.Title level={2}>Tecnologia compativel</Typography.Title>
          <Typography.Paragraph>
...
export function CookiesPolicyPage() {
  return (
    <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <Card>
        <Typography>
          <Typography.Title level={2}>Cookies essenciais (sempre ativos)</Typography.Title>
          <ul>
          ...
          <Typography.Title level={2}>Cookies opcionais (consentidos)</Typography.Title>
          <ul>
